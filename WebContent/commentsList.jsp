...
<%@page import="com.bean.CommentsBean"%>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Comments</h3>
                            </div>
                            <div class="panel-body">
 <form action="" name="comments" id="comments">

<center>
<table class="table table-bordered table-hover">

<%
List<CommentsBean> commentsList = (ArrayList)request.getAttribute("commentsList");
...
for(int i=0;i<commentsList.size();i++){
	CommentsBean comments= commentsList.get(i);
...
<td><%=comments.getDescription()%></td>
<td><%=comments.getDateOfCreation()%></td>


<td>
<a href="CommentsEditServlet?id=<%=comments.getId()%>">EDIT</a> &nbsp;&nbsp;&nbsp;
<a href="CommentsDeleteServlet?id=<%=comments.getId()%>">DELETE</a>
</td>
</tr>
