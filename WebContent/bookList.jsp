                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                                               <form action="" name="book" id="book">

<center>
<table class="table table-bordered table-hover">

<%
List<BookBean> bookList = (ArrayList)request.getAttribute("bookList");
...
<a href="BookEditServlet?id=<%=book.getId()%>">EDIT</a> &nbsp;&nbsp;&nbsp;
<a href="BookDeleteServlet?id=<%=book.getId()%>">DELETE</a>
</td>
</tr>
