                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Edit Category</h3>
                            </div>
                            <div class="panel-body">
<form action="CategoryUpdateServlet" name="categoryPage" id="categoryPage" method="post">
<input type="hidden" name="id" id="id" value="${categoryBean.id}">
...
<tr>
<th>category name : </th>
<td><input type="text" name="name" id="name" value="${categoryBean.name}"> ${name} </td>
</tr>

<tr>
<th>description : </th>
<td><input type="text" name="description" id="description" value="${categoryBean.description}"> ${description} </td>
</tr>
