                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Edit Message</h3>
                            </div>
                            <div class="panel-body">
<form action="MessagesUpdateServlet" name="messagesPage" id="messagesPage" method="post">
<input type="hidden" name="id" id="id" value="${messages.id}">


<table class="table table-bordered" align="center" id="demo">
<% MessagesBean messagesBean = (MessagesBean)request.getAttribute("messagesBean"); %>



<tr>
<th>message : </th>
<td><input type="text" name="description" id="description" value="${messages.description}"> ${description} </td>
</tr>
