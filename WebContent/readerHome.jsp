...
<body>
<h3><label class="label col-sm-2 col-xs-12" for="Emailmsg"><p style="font-size: 1.5em;color: #000000" >Welcome reader</p></label></h3>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-12">
					  ...
					  <form> <input type=text><br/><b>Enter author's mail id</b></form>
					
						<h3><label class="label col-sm-2 col-xs-12" for="Emailmsg"><p style="font-size: 1.5em;color: #000000" >Ask Question</p></label></h3>	
