                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Edit Book</h3>
                            </div>
                            <div class="panel-body">
<form action="BookUpdateServlet" name="bookPage" id="bookPage" method="post">
...
<tr>
<th>Title : </th>
<td><input type="text" name="title" id="title" value="${book.title}"> ${title} </td>
</tr>
...
<th>Description : </th>
<td>
<input type="text" name="description" id="description" value="${book.description}"> ${description}
</td>
</tr>
...
<th>isbn : </th>
<td>
<input type="text" name="isbn" id="isbn" value="${book.isbn}">${isbn} 
</td>
</tr>
...
<th>price : </th>
<td>
<input type="text" name="price" id="price" value="${book.price}">${price} 
</td>
</tr>
