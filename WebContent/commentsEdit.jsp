                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Edit Comment</h3>
                            </div>
                            <div class="panel-body">
<form action="CommentsUpdateServlet" name="commentsPage" id="commentsPage" method="post">
<input type="hidden" name="id" id="id" value="${comments.id}">


<table class="table table-bordered" align="center" id="demo">
<% CommentsBean commentsBean = (CommentsBean)request.getAttribute("commentsBean"); %>



<tr>
<th>comment : </th>
<td><input type="text" name="description" id="description" value="${comments.description}"> ${description} </td>
</tr>
