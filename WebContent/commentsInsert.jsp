                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Comments Insert</h3>
                            </div>
                            <div class="panel-body">
<form action="CommentsInsertServlet" name="commentsPage" id="commentsPage" method="post">
