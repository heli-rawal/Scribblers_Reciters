                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> User Type Insert</h3>
                            </div>
                            <div class="panel-body">
                                                <form action="UserTypeInsertServlet" name="userTypePage" id="userTypePage" method="post">
<table class="table table-bordered table-hover">

<tr>
<th>Enter New User Type : </th>
