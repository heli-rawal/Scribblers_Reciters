                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Edit User Type</h3>
                            </div>
                            <div class="panel-body">

<form action="UserTypeUpdateServlet" name="userTypePage" id="userTypePage" method="post">
<input type="hidden" name="userTypeId" id="userTypeId" value="${userTypeBean.userTypeId}">


<table class="table table-bordered" align="center" id="demo">
<% UserTypeBean userTypeBean = (UserTypeBean)request.getAttribute("userTypeBean"); %>



<tr>
<th>user type : </th>
<td><input type="text" name="userType" id="userType" value="${userTypeBean.userType}"> ${userType} </td>
</tr>
