                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Edit User</h3>
                            </div>
                            <div class="panel-body">
<form action="UserUpdateServlet" name="userPage" id="userPage" method="post">
...
<tr>
<th>Name : </th>
<td><input type="text" name="name" id="name" value="${user.name}"> ${name} </td>
</tr>
...
<th>Email : </th>
<td>
<input type="text" name="email" id="email" value="${user.email}"> ${email}
</td>
</tr>
...
<th>Password : </th>
<td>
<input type="password" name="password" id="password" value="${user.password}">${password} 
</td>
</tr>
...
if(securityQuestionList!=null){
	...
	for(int i =0;i<securityQuestionList.size();i++){
		SecurityQuestionBean securityQuestionBean= securityQuestionList.get(i);
		
		if(securityQuestionBean.getSecurityQuestionId()==(userBean.getSecurityQuestionId())){
%>
			<option value="<%=securityQuestionBean.getSecurityQuestionId()%>" selected="selected"><%=securityQuestionBean.getSecurityQuestion()%></option>

<%		}else{ %>

			<option value="<%=securityQuestionBean.getSecurityQuestionId()%>"><%=securityQuestionBean.getSecurityQuestion()%></option>
...
<td>
<input type="text" name="securityAnswer" id="securityAnswer" value="${user.securityAnswer}">${securityAnswer} 
</td>
</tr>
...
<% List<UserTypeBean> userTypeIdList= new UserTypeDao().select(); 

if(userTypeIdList!=null){
	
	for(int i =0;i<userTypeIdList.size();i++){
		UserTypeBean userTypeBean= userTypeIdList.get(i);
		
		if(userTypeBean.getUserTypeId()==(userBean.getUserTypeId())){
%>
			<option value="<%=userTypeBean.getUserTypeId()%>" selected="selected"><%=userTypeBean.getUserType()%></option>

<%		}else{ %>

			<option value="<%=userTypeBean.getUserTypeId()%>"><%=userTypeBean.getUserType()%></option>
