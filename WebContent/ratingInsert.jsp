...
<%@page import="com.bean.RatingBean"%>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Rating Insert</h3>
                            </div>
                            <div class="panel-body">
<form action="RatingInsertServlet" name="commentsPage" id="commentsPage" method="post">
<table class="table table-bordered table-hover">

<tr>
<th>ADD rating : </th>
<td>0 <br/><input type="radio" value="0" name="description" id="description"> ${description} </td>
<td>1 <br/><input type="radio" value="1" name="description" id="description"> ${description} </td>
<td>2 <br/><input type="radio" value="2" name="description" id="description"> ${description} </td>
<td>3 <br/><input type="radio" value="3" name="description" id="description"> ${description} </td>
<td>4 <br/><input type="radio" value="4" name="description" id="description"> ${description} </td>
<td>5 <br/><input type="radio" value="5" name="description" id="description"> ${description} </td>
</tr>
