                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Edit Rating</h3>
                            </div>
                            <div class="panel-body">
<form action="RatingUpdateServlet" name="ratingPage" id="ratingPage" method="post">
...
<tr>
<th>ADD rating : </th>
<td>0<input type="radio" value="0" name="description" id="description"> ${description} </td>
<td>1<input type="radio" value="1" name="description" id="description"> ${description} </td>
<td>2<input type="radio" value="2" name="description" id="description"> ${description} </td>
<td>3<input type="radio" value="3" name="description" id="description"> ${description} </td>
<td>4<input type="radio" value="4" name="description" id="description"> ${description} </td>
<td>5<input type="radio" value="5" name="description" id="description"> ${description} </td>
</tr>
