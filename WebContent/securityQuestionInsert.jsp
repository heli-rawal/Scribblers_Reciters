                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Security Question Insert</h3>
                            </div>
                            <div class="panel-body">
<form action="SecurityQuestionInsertServlet" name="securityQuestionPage" id="securityQuestionPage" method="post">
<table class="table table-bordered table-hover">

<tr>
<th>Enter New Security question : </th>
<td><input type=text name="securityQuestion" id="securityQuestion"> ${securityQuestion}</td>
</tr>
