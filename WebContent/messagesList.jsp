...
<%@page import="com.bean.MessagesBean"%>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Messages</h3>
                            </div>
                            <div class="panel-body">
                                                               <form action="" name="messages" id="messages">

<center>
 <table class="table table-bordered table-hover">

<%
List<MessagesBean> messagesList = (ArrayList)request.getAttribute("messagesList");
...
for(int i=0;i<messagesList.size();i++){
	MessagesBean messages= messagesList.get(i);
...
<td><%=messages.getDescription()%></td>
<td><%=messages.getDateOfCreation()%></td>


<td>
<a href="MessagesEditServlet?id=<%=messages.getId()%>">EDIT</a> &nbsp;&nbsp;&nbsp;
<a href="MessagesDeleteServlet?id=<%=messages.getId()%>">DELETE</a>
</td>
</tr>
