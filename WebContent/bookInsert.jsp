                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>Book Insert</h3>
                            </div>
                            <div class="panel-body">
<form action="BookInsertServlet" name="userPage" id="userPage" method="post">
...
<td><input type="text" name="title" id="title"> ${title} </td>
</tr>


<tr>
<td align="center">description : </td>
<td><input type="text" name="description" id="description"> ${description} </td>
</tr>
...
<td>
<input type="text" name="isbn" id="isbn"> ${isbn}
</td>
</tr>
