                    ...
                    <li class="active">
                      ...
                      <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="securityQuuestionInsert.jsp">Security Question Insert</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>Security Question</h3>
                            </div>
                            <div class="panel-body">
<form action="" name="securityQuestionPage" id="securityQuestionPage">

<center>
<table class="table table-bordered table-hover">

<%
List<SecurityQuestionBean> securityQuestionList = (ArrayList)request.getAttribute("securityQuestionList");
...
<td><%=securityQuestionBean.getSecurityQuestionId()%></td>
<td><%=securityQuestionBean.getSecurityQuestion()%></td>
<td>

<a href="SecurityQuestionEditServlet?securityQuestionId=<%=securityQuestionBean.getSecurityQuestionId()%>">EDIT</a> &nbsp;&nbsp;&nbsp;
<a href="SecurityQuestionDeleteServlet?securityQuestionId=<%=securityQuestionBean.getSecurityQuestionId()%>">DELETE</a>
</td>
</tr>
