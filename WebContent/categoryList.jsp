                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Categories</h3>
                            </div>
                            <div class="panel-body">
                                                              <form action="" name="categoryPage" id="categoryPage">

<center>
<table class="table table-bordered table-hover">

<%
List<CategoryBean> categoryList = (ArrayList)request.getAttribute("categoryList");
...
<td><%=categoryBean.getId()%></td>
<td><%=categoryBean.getName()%></td>
<td><%=categoryBean.getDescription()%></td>
<td>

<a href="CategoryEditServlet?id=<%=categoryBean.getId()%>">EDIT</a> &nbsp;&nbsp;&nbsp;
<a href="CategoryDeleteServlet?id=<%=categoryBean.getId()%>">DELETE</a>
</td>
</tr>
