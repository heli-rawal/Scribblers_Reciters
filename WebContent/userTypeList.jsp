<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@page import="com.dao.MessagesDao"%>
                    ...
                    <li class="active">
                      ...
                      <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="userInsert.jsp">Rating</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Types of Users</h3>
                            </div>
                            <div class="panel-body">
                                                              <form action="" name="userTypePage" id="userTypePage">

<center>
<table class="table table-bordered table-hover">

<%
List<UserTypeBean> userTypeList = (ArrayList)request.getAttribute("userTypeList");
...
for(int i=0;i<userTypeList.size();i++){
	UserTypeBean userTypeBean = userTypeList.get(i);

%>

<tr>

<td><%=userTypeBean.getUserTypeId()%></td>
<td><%=userTypeBean.getUserType()%></td>
<td>

<a href="UserTypeEditServlet?userTypeId=<%=userTypeBean.getUserTypeId()%>">EDIT</a> &nbsp;&nbsp;&nbsp;
<a href="UserTypeDeleteServlet?userTypeId=<%=userTypeBean.getUserTypeId()%>">DELETE</a>
</td>
</tr>
