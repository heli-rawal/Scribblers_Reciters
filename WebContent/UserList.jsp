                    ...
                    <li class="active">
                      ...
                      <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="commentInsert.jsp">Comments Insert</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="securityInsert.jsp">Security Question Insert</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i> Users</h3>
                            </div>
...
<%
List<UserBean> userList = (ArrayList)request.getAttribute("userList");
...
<td><%=user.getName()%></td>
<td><%=user.getEmail()%></td>
<td><%=user.getSecurityQuestionId() %></td>
<td><%=user.getSecurityAnswer() %></td>
<td><%=user.getUserTypeId() %></td>
<td>

<a href="UserEditServlet?id=<%=user.getId()%>">EDIT</a> &nbsp;&nbsp;&nbsp;
<a href="UserDeleteServlet?id=<%=user.getId()%>">DELETE</a>
</td>
</tr>
