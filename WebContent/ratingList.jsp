                    ...
                    <li class="active">
                      ...
                      <li>
                        ...
                        <ul id="demo" class="collapse">
                            ...
                            <li>
                                <a href="booksInsert.jsp">Books Insert</a>
                            </li>
                            <li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>Rating</h3>
                            </div>
...
<%
List<RatingBean> ratingList = (ArrayList)request.getAttribute("ratingList");
...
for(int i=0;i<ratingList.size();i++){
	RatingBean rating= ratingList.get(i);
...
<td><%=rating.getDateOfCreation()%></td>


<td>
<a href="RatingEditServlet?id=<%=rating.getId()%>">EDIT</a> &nbsp;&nbsp;&nbsp;
<a href="RatingDeleteServlet?id=<%=rating.getId()%>">DELETE</a>
</td>
</tr>
